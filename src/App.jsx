...
const AnalyticsReportPage = lazy(() => import('./pages/portal/AnalyticsReportPage'))
...
const PerformanceReportPage  = lazy(() => import('./pages/portal/PerformanceReportPage'))
            ...
            <ProtectedRoute>
              <PortalLayout>
                <Routes>
                  ...
                  <Route path="analytics/:id" element={<AnalyticsReportPage />} />
                  <Route path="tickets" element={<TicketsPage />} />
                  <Route path="tickets/new" element={<NewTicketPage />} />
                  <Route path="tickets/:id" element={<TicketDetailPage />} />
                  <Route path="performance"  element={<PerformancePage />} />
                  <Route path="performance/:id" element={<PerformanceReportPage />} />
