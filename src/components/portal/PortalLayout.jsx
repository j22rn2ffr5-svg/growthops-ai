...
import { LayoutDashboard, BarChart3, Ticket, LogOut, Menu, X, Zap, ShieldCheck, Mail, Users, Settings, Megaphone } from 'lucide-react'
...
export default function PortalLayout({ children }) {
  ...
  const companyName = isAdmin ? 'Admin' : (profile?.business_name ?? '')
